...
actor_ids:
  ...
  - tadasu
  - coela
audio_file_path: https://traffic.libsyn.com/secure/researchat/48.mp3
...
- XX型/XO型 ... 雌がXX、雄がXOという性染色体を持つ場合を指す。Oはこの場合Y染色体が存在しないことを指す。バッタなどでみられる。
- XO型/XO型 ... アマミトゲネズミなどでみられる (2025/03/14 追記修正しました。)
